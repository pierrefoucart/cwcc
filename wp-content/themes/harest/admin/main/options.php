...
function thinkup_customizer_theme_options( $wp_customize ) {
	...
	$wp_customize->add_section(
		...
		array(
			'title'    => __( 'General Settings', 'harest' ),
			'priority' => 10,
	...
	$wp_customize->add_section(
		...
		array(
			'title'    => __( 'Homepage (Featured)', 'harest' ),
			'priority' => 30,
			'panel'    => 'thinkup_customizer_section_themeoptions',
		)
	);
	...
	$wp_customize->add_section(
		...
		array(
			'title'    => __( 'Upgrade (10% off)', 'harest' ),
			'priority' => 80,
			'panel'    => 'thinkup_customizer_section_themeoptions',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_upgrade(
			...
			array(
				...
				'title_main'	  => __( 'So&hellip; Why upgrade?', 'harest' ),
				'title_secondary' => __( 'We&#39;re glad you asked! Here&#39;s just some of the amazing features you&#39;ll get when you upgrade&hellip;', 'harest' ),
				'images'		  => array(
