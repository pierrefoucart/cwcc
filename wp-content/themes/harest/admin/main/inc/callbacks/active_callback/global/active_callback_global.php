...
function thinkup_customizer_callback_active_global( $control ) {
	...
	$thinkup_homepage_introactionlink2 = $control->manager->get_setting('thinkup_redux_variables[thinkup_homepage_introactionlink2]')->value();
	...
	// Homepage - Call To Action - Intro
	if ( $thinkup_homepage_introactionlink2 == 'option1' and
			$control_id == 'thinkup_homepage_introactionpage2' ) {
		return true;
	} else if ( $thinkup_homepage_introactionlink2 == 'option2' and
			$control_id == 'thinkup_homepage_introactioncustom2' ) {
		return true;
	}
