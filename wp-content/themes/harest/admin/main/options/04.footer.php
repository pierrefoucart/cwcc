...
function thinkup_input_footerw1() {
	...
	echo	'<h3 class="widget-title">' . __( 'Please Add Widgets', 'harest') . '</h3>',
			'<div class="error-icon">',
			'<p>' . __( 'Remove this message by adding widgets to Footer Widget Area 1.', 'harest') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr_e( 'No Widgets Selected', 'harest' ) . '">' . __( 'Click here to go to Widget area.', 'harest') . '</a>',
			'</div>';
	};
	echo	'</div>';
}
...
function thinkup_input_footerw2() {
	...
	echo	'<h3 class="widget-title">' . __( 'Please Add Widgets', 'harest') . '</h3>',
			'<div class="error-icon">',
			'<p>' . __( 'Remove this message by adding widgets to Footer Widget Area 2.', 'harest') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr_e( 'No Widgets Selected', 'harest' ) . '">' . __( 'Click here to go to Widget area.', 'harest') . '</a>',
			'</div>';
	};
	echo	'</div>';
...
function thinkup_input_footerw3() {
	...
	echo	'<h3 class="widget-title">' . __( 'Please Add Widgets', 'harest') . '</h3>',
			'<div class="error-icon">',
			'<p>' . __( 'Remove this message by adding widgets to Footer Widget Area 3.', 'harest') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr_e( 'No Widgets Selected', 'harest' ) . '">' . __( 'Click here to go to Widget area.', 'harest') . '</a>',
			'</div>';
	};	
	echo	'</div>';
...
function thinkup_input_footerw4() {
	...
	echo	'<h3 class="widget-title">' . __( 'Please Add Widgets', 'harest') . '</h3>',
			'<div class="error-icon">',
			'<p>' . __( 'Remove this message by adding widgets to Footer Widget Area 4.', 'harest') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr_e( 'No Widgets Selected', 'harest' ) . '">' . __( 'Click here to go to Widget area.', 'harest') . '</a>',
			'</div>';
	};	
	echo	'</div>';
...
function thinkup_input_footerw5() {
	...
	echo	'<h3 class="widget-title">' . __( 'Please Add Widgets', 'harest') . '</h3>',
			'<div class="error-icon">',
			'<p>' . __( 'Remove this message by adding widgets to Footer Widget Area 5.', 'harest') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr_e( 'No Widgets Selected', 'harest' ) . '">' . __( 'Click here to go to Widget area.', 'harest') . '</a>',
			'</div>';
	};	
	echo	'</div>';
...
function thinkup_input_footerw6() {
	...
	echo	'<h3 class="widget-title">' . __( 'Please Add Widgets', 'harest') . '</h3>',
			'<div class="error-icon">',
			'<p>' . __( 'Remove this message by adding widgets to Footer Widget Area 6.', 'harest') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr_e( 'No Widgets Selected', 'harest' ) . '">' . __( 'Click here to go to Widget area.', 'harest') . '</a>',
			'</div>';
	};	
	echo	'</div>';
